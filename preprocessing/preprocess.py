...
def preprocess_v2(root, lang1, lang2, keep_comments, local, lang3=None, test_size=1000):
    dataset = Dataset(root, lang1, lang2, keep_comments, test_size=test_size, lang3=lang3)
    ...
    dataset.process_languages(
        lang_executor=mp_executor, tok_executor=cluster_ex1, split_executor=cluster_ex2)
    dataset.extract_functions(
        lang_executor=mp_executor, function_executor=cluster_ex2)
    # dataset.extract_docstrings(
    #     lang_executor=mp_executor, function_executor=cluster_ex2)
...
if __name__ == '__main__':
    ...
    preprocess_v2(args.root, args.lang1, args.lang2, args.keep_comments, args.local,
                  lang3=args.lang3, test_size=args.test_size)
    # preprocess_v2(args.root, 'java', 'python', args.keep_comments, args.local,
    #               None, test_size=args.test_size)
    # preprocess_v2(args.root, 'cpp', None, args.keep_comments, args.local, None, test_size=args.test_size)
