...
from .transformer import TransformerModel, init_bert_params
from fairseq.models.bart import BARTHubInterface

logger = logging.getLogger(__name__)


@register_model('bart_rel_attn')
...
@register_model_architecture('bart_rel_attn', 'bart_rel_attn_large')
def bart_large_architecture(args):
    ...
    args.ignore_direction = getattr(args, "ignore_direction", False)


@register_model_architecture('bart_rel_attn', 'bart_rel_attn_base')
...
@register_model_architecture('bart_rel_attn', 'mbart_rel_attn_large')
def mbart_large_architecture(args):
    args.no_scale_embedding = getattr(args, 'no_scale_embedding', False)
    bart_large_architecture(args)


@register_model_architecture('bart_rel_attn', 'mbart_rel_attn_base')
